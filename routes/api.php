...
Route::post('/kelilingpersegipanjang', [App\Http\Controllers\Api\PersegiPanjangController::class , 'hitungkelilingPersegiPanjang']);
Route::post('/kelilinglingkaran', [App\Http\Controllers\Api\KelilingLingkaranController::class , 'hitungKelilingLingkaran']);
Route::post('/luaslingkaran', [App\Http\Controllers\Api\LuasLingkaranController::class , 'hitungluasLingkaran']);
